package com.omelchenkoaleks.workexamplewithmap;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickAddCountry(View view) {
        if (fieldsAreFilled()) {
            countries.put(editTextCountry.getText().toString().trim(),
                    editTextCapital.getText().toString().trim());
    ...
    private boolean fieldsAreFilled() {
        return editTextCapital.getText() != null
                && !editTextCapital.getText().toString().trim().isEmpty()
                && editTextCountry.getText() != null
                && !editTextCountry.getText().toString().trim().isEmpty();
    }
    ...
    private void showAllCountries() {
        ...
        for (String country : countries.keySet()) {
            builder.append(country).append(" - ").append(countries.get(country))
                    .append("\n");
        }
